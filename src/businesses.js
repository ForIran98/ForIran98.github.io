            ...
            <div class="flex-1 w-full">
              <div class="flex flex-col md:flex-row md:items-center md:gap-4">
                ...
                <div class="flex gap-2 mt-2 md:mt-0">
                  ${biz.contact && biz.contact.trim() !== '' ? `<a href="tel:${biz.contact}" title="تماس" class="inline-block text-green-600 hover:text-green-800" target="_blank" rel="noopener"><svg xmlns='http://www.w3.org/2000/svg' class='inline w-5 h-5' fill='none' viewBox='0 0 24 24' stroke='currentColor'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M3 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H5a2 2 0 01-2-2V5zm0 14a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5a2 2 0 00-2 2v2zm14-14a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5a2 2 0 012-2h2zm0 14a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2h-2a2 2 0 00-2 2v2z' /></svg></a>` : ''}
                  ${biz.instagram && biz.instagram.trim() !== '' ? `<a href="${biz.instagram}" title="اینستاگرام" class="inline-block text-pink-500 hover:text-pink-700" target="_blank" rel="noopener"><svg xmlns='http://www.w3.org/2000/svg' class='inline w-5 h-5' fill='currentColor' viewBox='0 0 24 24'><path d='M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5A4.25 4.25 0 0 0 7.75 20.5h8.5a4.25 4.25 0 0 0 4.25-4.25v-8.5A4.25 4.25 0 0 0 16.25 3.5zm4.25 3.25a5.25 5.25 0 1 1 0 10.5a5.25 5.25 0 0 1 0-10.5zm0 1.5a3.75 3.75 0 1 0 0 7.5a3.75 3.75 0 0 0 0-7.5zm5.25.75a1 1 0 1 1-2 0a1 1 0 0 1 2 0z'/></svg></a>` : ''}
                  ${biz.link ? `<a href="${biz.link}" title="وبسایت" class="inline-block text-blue-600 hover:text-blue-800" target="_blank" rel="noopener"><svg xmlns='http://www.w3.org/2000/svg' class='inline w-5 h-5' fill='none' viewBox='0 0 24 24' stroke='currentColor'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M14 3h7v7m0 0L10 21l-7-7L17 3z' /></svg></a>` : ''}
                </div>
              </div>
